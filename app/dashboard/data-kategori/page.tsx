...
import {
  ...
  updateCategory,
  deleteCategory,
} from "@/app/controller/kategori.controller";
import type { Kategori, KategoriPayload } from "@/app/model/kategori.model";

const EMPTY_FORM: KategoriPayload = {
  nama: "",
  deskripsi: "",
};
...
export default function DataKategoriPage() {
  ...
  const [form, setForm] = useState<KategoriPayload>(EMPTY_FORM);
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-100">
                  {["#", "Nama Kategori", "Deskripsi", "Dibuat", "Aksi"].map(
                    (h) => (
                      <th
                        key={h}
            ...
            <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">
                  {editCategory
                    ? `Mengedit kategori ${editCategory.nama}`
