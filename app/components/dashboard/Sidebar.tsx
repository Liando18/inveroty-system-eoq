...
export const MENU: { label: string; id: NavId; Icon: ComponentType }[] = [
  { label: "Dashboard", id: "dashboard", Icon: IcoGrid },
  { label: "Data Akun", id: "akun", Icon: IcoUser },
  { label: "Data Supplier", id: "supplier", Icon: IcoTruck },
  { label: "Data Kategori", id: "kategori", Icon: IcoTag },
  { label: "Data Produk", id: "produk", Icon: IcoBox },
  { label: "Barang Masuk", id: "barang-masuk", Icon: IcoIn },
  { label: "Barang Keluar", id: "barang-keluar", Icon: IcoOut },
  { label: "Stok", id: "stok", Icon: IcoLayers },
  { label: "Analisis", id: "analisis", Icon: IcoChart },
  { label: "Laporan", id: "laporan", Icon: IcoFile },
];
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-3 border-t border-white/10 mt-2">
        <Link
          href="/"
          className={`flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-white/40 hover:bg-white/[0.06] hover:text-white/70 transition-all duration-150 ${collapsed && !mobile ? "justify-center px-0" : ""}`}>
          <svg
